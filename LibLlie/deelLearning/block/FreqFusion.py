"""
    Note:
    This code is from https://github.com/Linwei-Chen/FreqFusion?tab=readme-ov-file
    paper: TPAMI 2024：Frequency-aware Feature Fusion for Dense Image Prediction
"""
